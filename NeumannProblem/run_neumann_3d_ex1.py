    ...
    for N_list in [[2**3,2**3,2**3]]: 
        for trial in range(trial_num):
            ...
            if save: 
                ...
                filename = folder + 'errl2_NeumannOGA_3D_{}_relu{}_neuron_{}_N_{}_randomized_trial_{}.pt'.format(function_name,relu_k,num_epochs,N,trial)
                torch.save(err_QMC2,filename) 
                filename = folder + 'errh10_NeumannOGA_3D_{}_relu{}_neuron_{}_N_{}_randomized_trial_{}.pt'.format(function_name,relu_k,num_epochs,N,trial)
                torch.save(err_h10,filename) 
                filename = folder + 'model_NeumannOGA_3D_{}_relu{}_neuron_{}_N_{}_randomized_trial_{}.pt'.format(function_name,relu_k,num_epochs,N,trial)
