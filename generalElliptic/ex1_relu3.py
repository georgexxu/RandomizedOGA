...
f_write.write("{} k = {}, Integration points: Nx {}, order {} \n".format(activation, relu_k,Nx,order))
f_write.close() 
save = True 
write2file = True 
memory = 2**29
...
for N_list in [[2**3,2**3,2**3]]:   
    for trial in range(trial_num):
        ...
        if save: 
            ...
            filename = folder + 'model_OGA_3D_{}_{}_{}_neuron_{}_N_{}_rand_trial_{}.pt'.format(function_name,activation, relu_k, num_epochs,N,trial)
